...
#  Jun 02, 2023 05:27:42 PM -03  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -background #ffa6ff -highlightbackground $vTcl(actual_gui_bg) \
...
### SPOT dump_widget_opt A
    entry "$site_3_0.ent52" \
        ...
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 214 
    vTcl:DefineAlias "$site_3_0.ent52" "Entry1_1" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
...
### SPOT dump_widget_opt A
    button "$site_3_0.but58" \
        ...
        -background $vTcl(actual_gui_bg) -borderwidth 0 -compound left \
        -disabledforeground #a3a3a3 \
        -font "-family Arial -size 9 -weight normal -slant roman -underline 1 -overstrike 0" \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text "Esqueceu sua senha?" 
...
### SPOT dump_widget_opt A
    place $site_3_0.lab49 \
        -in $site_3_0 -x 0 -relx 0.234 -y 0 -rely 0.232 -width 0 \
        -relwidth 0.244 -height 0 -relheight 0.09 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent50 \
        -in $site_3_0 -x 0 -relx 0.234 -y 0 -rely 0.319 -width 214 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab51 \
        -in $site_3_0 -x 0 -relx 0.234 -y 0 -rely 0.406 -width 0 \
        -relwidth 0.192 -height 0 -relheight 0.09 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent52 \
        -in $site_3_0 -x 0 -relx 0.234 -y 0 -rely 0.493 -width 214 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but55 \
        -in $site_3_0 -x 0 -relx 0.234 -y 0 -rely 0.638 -width 211 \
        -relwidth 0 -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but57 \
        -in $site_3_0 -x 0 -relx 0.494 -y 0 -rely 0.754 -width 121 \
        -relwidth 0 -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but58 \
        -in $site_3_0 -x 0 -relx 0.42 -y 0 -rely 0.551 -width 137 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab59 \
        -in $site_3_0 -x 0 -relx 0.234 -y 0 -rely 0.754 -width 0 \
        -relwidth 0.296 -height 0 -relheight 0.061 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab60 \
        -in $site_3_0 -x 0 -relx 0.39 -y 0 -rely 0.058 -width 0 \
        -relwidth 0.218 -height 0 -relheight 0.119 -anchor nw \
        -bordermode ignore 
    label "$top.lab61" \
        -activebackground #f9f9f9 -activeforeground SystemButtonText \
        -anchor w -background #ffa6ff -compound left \
        -disabledforeground #a3a3a3 \
        -font "-family Arial -size 11 -weight bold -slant roman -underline 0 -overstrike 0" \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text "STS - Sistema de Teste de Software" 
...
### SPOT dump_widget_opt A
    ...
    ###################
    place $top.fra47 \
        -in $top -x 0 -relx 0.183 -y 0 -rely 0.111 -width 0 -relwidth 0.642 \
        -height 0 -relheight 0.767 -anchor nw -bordermode ignore 
    place $top.lab61 \
        -in $top -x 0 -relx 0.3 -y 0 -rely 0.022 -width 0 -relwidth 0.44 \
